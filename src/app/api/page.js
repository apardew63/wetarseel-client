...
export default function ApiPage() {
  ...
  const sidebarItems = [
    ...
    { key: "api", icon: <SoundOutlined />, label: "API Settings", active: true },
      ...
      <Layout>
        ...
        <Content className="p-6 bg-gray-50">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-3xl font-bold text-gray-900 mb-6">API Settings</h1>
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <p className="text-gray-500">API configuration and settings will be implemented here</p>
            </div>
          </div>
        </Content>
      </Layout>
