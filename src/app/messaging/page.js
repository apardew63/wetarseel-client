...
export default function MessagingPage() {
  ...
  const sidebarItems = [
    ...
    { key: "messaging", icon: <SoundOutlined />, label: "Messaging Limits", active: true },
      ...
      <Layout>
        ...
        <Content className="p-6 bg-gray-50">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-3xl font-bold text-gray-900 mb-6">Messaging Limits</h1>
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <p className="text-gray-500">Messaging limits and quota management will be implemented here</p>
            </div>
          </div>
        </Content>
      </Layout>
