      ...
      <section className="min-h-screen w-full grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="flex items-center justify-center p-8 bg-background">
          <div className="w-full max-w-md space-y-6 p-4">
            <div className="p-4">
              <h1 className="font-bold text-2xl mb-3 w-full">
            ...
            <form onSubmit={(e) => { e.preventDefault(); onFinish({ email: e.target.email.value, password: e.target.password.value }); }} className="w-full flex flex-col  shadow-slate-300 items-center justify-center gap-2 p-4 rounded">
              {/* Email input */}
              <Input
                name="email"
                type="email"
                placeholder="Email"
                required
                className="flex h-10 w-full rounded-md border-2 border-gray-400 bg-white px-3 py-2 text-sm
              placeholder:text-gray-400 disabled:cursor-not-allowed disabled:opacity-50
              focus:ring-0 focus:outline-none focus:border-[#075E54]"
              />
              ...
              <div className="relative w-full">
                <Input
                  ...
                  required
                  className="flex h-10 w-full rounded-md border-2 border-gray-400 bg-white px-3 py-2 pr-10 text-sm
                placeholder:text-gray-400 disabled:cursor-not-allowed disabled:opacity-50
                focus:ring-0 focus:outline-none focus:border-[#075E54]"
                />
                <button
            ...
            <div className="p-4 text-center">
              ...
              <p className="mb-2 text-gray-800">
                If you don&apos;t remember your password, then login with OTP
              </p>

              <button
                className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-blue-100 text-blue-500 underline-offset-4 hover:underline h-10 px-4 py-2"
                type="button"
                value="otpLogin"
                name="otpLogin"
              >
